"""
Flux2Klein Local 4-GPU Inference Script - GA2

Local inference on 4x A100 GPUs for GA2 checkpoints.
Checkpoints: 53500, 52000, 50500, 49000, 47500, 45500, 43500
CFG values: 4.0, 3.5
Steps: 50

Usage:
    accelerate launch --num_processes=4 test/test_flux2klein_local_4gpu_ga2.py
"""
...
OUTPUT_BASE = "/home/v-yuxluo/data/inference_results/0129_flux9B_GA2"
CONFIG_PATH = "/home/v-yuxluo/WORK_local/ArXivQwenImage/configs/260124/flux2klein_fulltune_50000_amlt_ga4.py"
CHECKPOINT_STEPS = [53500, 52000, 50500, 49000, 47500, 45500, 43500]
...
def main():
    ...
    if rank == 0:
        print(f"\n{'='*60}")
        print(f"Flux2Klein Local 4-GPU Inference - GA2")
        print(f"{'='*60}")
    ...
    if rank == 0:
        print(f"\n{'='*60}")
        print(f"All GA2 checkpoints processed!")
