"""
Flux2Klein Parquet Dataset Config - Testing New Model Factory Code
Usage: accelerate launch --config_file accelerate_cfg/1m4g_bf16.yaml train_OpenSciDraw_loop.py configs/260119/test_newcode_fluxklein_parquet_dataset_config_local.py
"""
...
# ====== 输出路径 ======
model_output_dir = '/home/v-yuxluo/data/experiments/260119_fluxklein_test/models'
image_output_dir = '/home/v-yuxluo/data/experiments/260119_fluxklein_test/samples'
logging_dir = 'logs'

# ====== 日志与监控 ======
report_to = 'wandb'
tracker_name = 'Flux2Klein-NewCode-Test'
run_name = "test_newcode_fluxklein_260119_local"
seed = 42
...
# ====== LoRA ======
use_lora = True
lora_layers = "to_k,to_q,to_v,add_q_proj,add_k_proj,add_v_proj,to_out.0,to_add_out,linear_in,linear_out"# Default Flux2 layers
rank = 128
lora_alpha = 128
lora_dropout = 0.0
layer_weighting = 5.0
...
# ====== 训练设置 ======
train_batch_size = 2  # Flux2Klein 9B is larger, may need smaller batch
num_train_epochs = 2
gradient_accumulation_steps = 1
optimizer = "prodigy"  # Use Prodigy for adaptive learning rate
learning_rate = 1.0  # Prodigy uses 1.0 as base
lr_warmup_steps = 0  # Prodigy doesn't need warmup
use_8bit_adam = False
...
train_iteration_func_name = 'Flux2Klein_train_iteration_func_parquet'  # Now implemented!

use_parquet_dataset = True
dataset = dict(
    type='ArXiVParquetDatasetV2',
    base_dir=base_filesys_path,
    parquet_base_path='ArXiV_parquet/flux_latents_test/',
...
max_sequence_length = 1024  # Flux2Klein uses shorter sequences

# ====== 精度 / 性能 ======
mixed_precision = "bf16"

# ====== 验证与推理 ======
validation_func_name = 'generic_validation_func'  # Use generic for Flux2Klein
validation_steps = 500
num_inference_steps = 28  # Flux2 typically uses fewer steps
guidance_scale = 3.5  # Flux2 uses guidance_scale instead of true_cfg_scale
negative_prompt = ""
