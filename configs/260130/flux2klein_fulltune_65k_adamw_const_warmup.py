"""
Flux2Klein 9B Full Fine-tuning Config - AdamW + constant_with_warmup scheduler
- optimizer = AdamW
...
huggingface_token = None  # Resolved from env or secrets.py
...
train_batch_size = 1
gradient_accumulation_steps = 2  # Effective batch = 1 * 2 * 4 GPUs = 8
...
# Output
model_output_dir = base_filesys_path + "experiments/260130_fluxklein9B_adamw_const_warmup"
...
tracker_run_name = "260130_adamw_const_warmup_1e-5"
